(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 34456))
 (memory $0 1)
 ...
 (data $12 (i32.const 1664) "\05\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\02\t")
 ...
 (export "mancalaOperator" (func $export:assembly/index/mancalaOperator))
 (start $~start)
 ...
 (func $assembly/index/update (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
 ...
 (func $assembly/index/evaluate (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $assembly/index/checkEnd (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
 ...
 (func $assembly/index/minValue (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
 ...
 (func $assembly/index/maxValue (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
 ...
 (func $assembly/index/mancalaOperator (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $export:assembly/index/mancalaOperator (param $0 i32) (param $1 i32) (result i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  global.set $~lib/memory/__stack_pointer
  ...
  local.get $0
  local.get $1
  call $assembly/index/mancalaOperator
  local.set $0
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.add
